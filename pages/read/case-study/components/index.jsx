...
export const HeaderComponent = ({ title, sub_title, overview }) => {
  return (
    <motion.section
      id="header-section"
...
export const ProblemComponent = ({ problem }) => {
  return (
    <motion.section
      id="problem-section"
      variants={parentVariantFadeIn}
...
export const SolutionsComponent = ({ solutions }) => {
  return (
    <motion.section
      id="solution-section"
      variants={parentVariantFadeIn}
...
export const ImpactComponent = ({ impact }) => {
  return (
    <motion.section
      id="impact-section"
      variants={parentVariantFadeIn}
...
export const ContributionsComponent = ({ contributions }) => {
  return (
    <motion.section
...
export const ConclusionComponent = ({ conclusion }) => {
  return (
    <motion.section
      id="problem-section"
      variants={parentVariantFadeIn}
...
const ImagePreview = ({ caption, src, alt }) => {
  return (
    <motion.div
      variants={childVariantFadeIn}
