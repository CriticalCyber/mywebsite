...
const LoadingTerminal = ({ setShowLoader }) => {
  const commands = [
    {
      id: "01",
      prefix: "$",
      cmd: "whois Anubhav Gupta",
      className: "text-secondary text-[14px] font-medium tracking-wider",
      resp: [
        {
          id: "02",
          prefix: ">",
          text: "Anubhav Gupta is a Frontend Developer & Cyber Security Enthusiast",
          className: "text-info text-[12px] font-light tracking-wider",
        },
        {
          id: "03",
          prefix: ">",
          text: "Currently as a fresher Frontend Developer",
          className: "text-info text-[12px] font-light tracking-wider",
        },
      ],
    },
    ...
    },
    {
      id: "10",
      prefix: "$",
      cmd: "Anubhav Gupta --hobbies-list",
      className: "text-secondary text-[14px] font-medium tracking-wider",
      resp: [
        {
          id: "11",
