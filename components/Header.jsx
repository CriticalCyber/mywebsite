        ...
        <div className="navbar-center">
          ...
          >
            <img
              ...
              alt="Anubhav Gupta Logo"
            />
            <FancyButton
              className={
                "w-17 text-left btn-sm btn-outline border-transparent bg-transparent shadow-none font-semibold text-base-content"
              }
              onClick={() => navigate("/")}
              text_1={"Anubhav"}
              text_2={"Gupta"}
